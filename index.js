...
app.use((req, res, next) => {
  res.setHeader("Access-Control-Allow-Origin", "kamuscrypto.id");
...
app.get("/", (req, res) => {
  res.json({
    message: "Welcome to the Kamus Crypto REST API",
  });
});
...
import newsAdminRouter from "./src/routes/admin/news.routes.js"; // News Router
